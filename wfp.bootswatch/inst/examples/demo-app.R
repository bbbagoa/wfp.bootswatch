...
ui <- page_navbar(
  ...
  nav_panel(
    ...
    p("The WFP color palette follows the organizational brand guidelines.", class = "text-muted mb-4"),
    ...
    layout_column_wrap(
      ...
      min_width = "150px",
      lapply(list(
        list(name = "WFP Blue", hex = "#007dbc", class = "bg-wfp-blue", text = "white"),
        list(name = "Navy", hex = "#19486a", class = "bg-wfp-navy", text = "white"),
        list(name = "Aqua", hex = "#26bde2", class = "bg-wfp-aqua", text = "dark"),
        list(name = "Dark Green", hex = "#336d37", class = "bg-wfp-green", text = "white"),
        list(name = "Lime", hex = "#8ad220", class = "bg-wfp-lime", text = "dark")
      ), function(col) {
        card(
          style = sprintf("background-color: %s; color: %s; min-height: 100px;", col$hex, if(col$text == "white") "#fff" else "#031c2d"),
          card_body(
            h5(col$name, style = sprintf("color: %s;", if(col$text == "white") "#fff" else "#031c2d")),
            code(col$hex, style = sprintf("color: %s; background: rgba(255,255,255,0.2); border: none;", if(col$text == "white") "#fff" else "#031c2d"))
          )
        )
      })
    ),
      ...
      lapply(list(
        ...
        card(
          ...
          card_body(
            ...
            code(col$hex, style = "color: #fff; background: rgba(0,0,0,0.2); border: none;")
          )
        )
      })
    ),
  ...
  nav_panel(
    ...
    p("WFP uses Open Sans as the primary typeface for Latin characters, with Noto Sans as the global fallback.", class = "text-muted mb-4"),
    ...
    p(class = "lead", "This is a lead paragraph. It stands out from regular paragraphs with slightly larger text."),
    p("This is a regular paragraph. WFP's typography system emphasizes readability and clean hierarchy with a focus on humanitarian clarity. The body text uses a comfortable line height and neutral color for optimal reading experience."),
    p("Another paragraph with ", a(href = "#", "a link"), ", ", strong("bold text"), ", and ", em("italic text"), "."),

    hr(),

    blockquote(class = "blockquote",
      p("This is a blockquote. It features a left border accent in WFP Blue for visual distinction."),
    ...
    p("Use ", del("del"), " for deleted text and ", ins("ins"), " for inserted text."),
...
ui <- fluidPage(
  ...
  nav_panel(
    ...
    div(class = "d-flex gap-2 flex-wrap",
      ...
      actionButton("btn_osecondary", "Secondary", class = "btn-outline-secondary"),
    ...
    div(class = "d-flex gap-2 flex-wrap",
      actionButton("btn_icon1", label = HTML("&#10003; Save"), class = "btn-primary"),
      actionButton("btn_icon2", label = HTML("&#8594; Next"), class = "btn-secondary"),
      actionButton("btn_icon3", label = HTML("&#128465; Delete"), class = "btn-danger"),
      actionButton("btn_icon4", label = HTML("&#9432; Info"), class = "btn-info")
    )
  ),
    ...
    layout_column_wrap(
      ...
      card(
        ...
        card_body(
          ...
          passwordInput("pwd_input", "Password Input", placeholder = "Enter password..."),
          textAreaInput("area_input", "Text Area", rows = 3, placeholder = "Enter longer text..."),
          numericInput("num_input", "Numeric Input", value = 42, min = 0, max = 100)
        )
      ),
  ...
  nav_panel(
    ...
    layout_column_wrap(
      ...
      card(
        card_header("Alerts"),
        card_body(
          div(class = "alert alert-primary", HTML("<strong>Primary!</strong> This is a primary alert.")),
          div(class = "alert alert-success", HTML("<strong>Success!</strong> This is a success alert.")),
          div(class = "alert alert-warning", HTML("<strong>Warning!</strong> This is a warning alert.")),
          div(class = "alert alert-danger", HTML("<strong>Danger!</strong> This is a danger alert.")),
          div(class = "alert alert-info", HTML("<strong>Info!</strong> This is an info alert.")),
          div(class = "alert alert-light", HTML("<strong>Light!</strong> This is a light alert.")),
          div(class = "alert alert-dark", HTML("<strong>Dark!</strong> This is a dark alert."))
        )
      ),
    ...
    layout_column_wrap(
      ...
      card(
        ...
        card_body(
          ...
          div(class = "mb-3",
            div(class = "d-flex justify-content-between mb-1",
              span("Warning"), span("75%")
            ),
            div(class = "progress",
              div(class = "progress-bar bg-warning text-dark", style = "width: 75%", "75%")
            )
          ),
          div(class = "mb-3",
            div(class = "d-flex justify-content-between mb-1",
    ...
    layout_column_wrap(
      ...
      card(
        ...
        card_body(
          tags$nav(
            tags$ul(class = "pagination justify-content-center",
              tags$li(class = "page-item disabled",
                tags$a(class = "page-link", href = "#", "Previous")
              ),
              tags$li(class = "page-item active",
    ...
    layout_column_wrap(
      ...
      card(
        ...
        card_body(
          tags$div(class = "list-group",
            tags$a(href = "#", class = "list-group-item list-group-item-action active",
      ...
      card(
        ...
        card_body(
          tabsetPanel(
            tabPanel("Overview", p("This is the overview tab with general information.")),
            tabPanel("Details", p("This tab contains detailed information about the selected item.")),
    ...
    card(
      ...
      card_body(
        layout_column_wrap(
          ...
          div(class = "wfp-stat wfp-stat-success",
    ...
    card(
      ...
      card_body(
        ...
        p(span(class = "status-dot status-inactive"), "Inactive", class = "me-4"),
  ...
  nav_panel(
    ...
    div(class = "wfp-hero",
      ...
      p("A complete Bootswatch theme based on the World Food Programme UI Kit design system for R Shiny applications."),
...
ui <- fluidPage(
  ...
  ...
      ...
      card(
        ...
        card_body(
          tags$ul(
            ...
            tags$li("WFP custom components (callouts, stat cards, status dots)"),
    ...
    div(class = "wfp-content-box mt-4",
      h4("Color Palette Reference"),
      p("The theme includes the full WFP color palette mapped to Bootstrap's semantic colors:"),
      tags$table(class = "table table-sm",
        ...
        tags$tbody(
          tags$tr(tags$td(tags$span(class = "badge bg-primary", "primary")), tags$td("WFP Blue"), tags$td(code("#007dbc"))),
          tags$tr(tags$td(tags$span(class = "badge bg-secondary", "secondary")), tags$td("Navy"), tags$td(code("#19486a"))),
          tags$tr(tags$td(tags$span(class = "badge bg-success", "success")), tags$td("Dark Green"), tags$td(code("#336d37"))),
          tags$tr(tags$td(tags$span(class = "badge bg-info", "info")), tags$td("Aqua"), tags$td(code("#26bde2"))),
          tags$tr(tags$td(tags$span(class = "badge bg-warning text-dark", "warning")), tags$td("Yellow"), tags$td(code("#f7b825"))),
          tags$tr(tags$td(tags$span(class = "badge bg-danger", "danger")), tags$td("Red"), tags$td(code("#c5192d"))),
          tags$tr(tags$td(tags$span(class = "badge bg-light text-dark", "light")), tags$td("Gray 3"), tags$td(code("#f5f7fa"))),
          tags$tr(tags$td(tags$span(class = "badge bg-dark", "dark")), tags$td("Dark Text"), tags$td(code("#031c2d")))
        )
      )
    ),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$about_btn, {
    showModal(modalDialog(
      ...
      p("This theme is based on the World Food Programme UI Kit design system."),
      p("It provides a complete, ready-to-use Bootstrap 5 theme for Shiny applications with WFP branding."),
      easyClose = TRUE,
